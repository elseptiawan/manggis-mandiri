            ...
            <div id="add-input-barang">
                <div class="d-flex mb-3">
                    <div style="margin-right: 15px">
                        ...
                        <input type="text" name="nama_barang[0]" id="nama_barang" class="form-control mb-2" required>
                    </div>
                    <div style="margin-right: 15px">
                        <label for="harga_jual">Harga Jual <span style="color: red">*</span></label>
                        <input type="number" name="harga_jual[0]" id="harga_jual" class="form-control mb-2" required>
                    </div>
                    <div style="margin-right: 15px">
                        <label for="jumlah">Jumlah <span style="color: red">*</span></label>
                        <input type="number" name="jumlah[0]" id="jumlah" class="form-control mb-2" required>
                    </div>
                    <div style="margin-right: 15px">
